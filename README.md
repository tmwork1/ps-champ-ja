...
- `data_raw/` `data_en/`: [Pokemon Showdown](https://github.com/smogon/pokemon-showdown) の
  `champions` mod から抽出
- `translation/*.csv` および、それを用いて生成した `data_jp/`: [ポケモンWiki](https://wiki.pokemonwiki.com/)
...
[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)。詳細は [LICENSE](./LICENSE) を参照。
